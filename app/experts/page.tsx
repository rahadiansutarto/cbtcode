        ...
        <div className="experts-container">
          <div className="experts-grid">
            ...
            <article className="expert-card">
              ...
              <p className="expert-quote">&ldquo;KJ is the first time that I&rsquo;ve seen industry-specific intelligence in an AI product. It&rsquo;s clear for ...&rdquo; <span className="read-more">Read more</span></p>
            ...
            <article className="expert-card">
              ...
              <p className="expert-quote">&ldquo;When I was CEO running multiple businesses across multiple geographies, I wish I could have an agent...&rdquo; <span className="read-more">Read more</span></p>
              <div className="expert-meta">
            ...
            <article className="expert-card">
              ...
              <p className="expert-quote">&ldquo;With Calvin Ball, your institutional savoir-faire becomes a repeatable product, not just a tribal kn...&rdquo; <span className="read-more">Read more</span></p>
              <div className="expert-meta">
            ...
            <article className="expert-card">
              ...
              <p className="expert-quote">&ldquo;The challenge today is bridging the gaps between what AI can do and the business needs. And that&rsquo;s w...&rdquo; <span className="read-more">Read more</span></p>
              <div className="expert-meta">
            ...
            <article className="expert-card">
              ...
              <p className="expert-quote">&ldquo;So imagine bottling your top palettes best instincts and scaling them instantly. That&rsquo;s what vertica...&rdquo; <span className="read-more">Read more</span></p>
              <div className="expert-meta">
